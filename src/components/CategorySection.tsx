        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-8 pb-4 border-b" style={{ borderColor: 'var(--rule)' }}>
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="overline text-[var(--ink-faint)]">{id}</span>
            </div>
          ...
          <a href={`#${id}`} className="hidden sm:inline-flex items-center gap-1.5 text-xs font-sans font-medium text-[var(--ink-faint)] hover:text-[var(--accent-editorial)] transition-colors self-end sm:self-auto">
